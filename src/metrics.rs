...
//!
//! The [`NoMetrics`] struct is a zero-sized struct that implements [`Metrics`] and simply drops all inputs.
//! It can be used for testing or when no metrics are required.
